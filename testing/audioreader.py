...
class AudioReader():
    ...
    def to_nparray(self, audiosegment, normalized=False):
    ...
    def segment_section(self, audiosegment, start, end):
        #return slice of audiosignal indicated by start and end in seconds
        segment = audiosegment[start*1000: end*1000]
        
        return segment
    
    def audio_np_section(self, audiosegment, start, end):
        #return slice of audiosignal indicated by start and end in seconds
        audiosegment_section = self.segment_section(audiosegment, start, end)
        audio_np_section = self.to_nparray(audiosegment_section)
